...
<div class="box box-primary">
    <div class="box-header">
        <i class="fa fa-list"></i>Catalogo de Tallas<br>
        <button class="btn btn-xs btn-primary" onclick="menu_catalogos(4,4)"><i class="fa fa-list"></i> Listado de tallas</button>
        <button class="btn btn-xs btn-default" onclick="nueva_tallas(1,0)"><i class="fa fa-file"></i> Nueva</button>
...
<script>
    ...
    var listar = function(){
        var table = $('#example').DataTable( {
            "ajax":{
                "url":"modules/applications/src/catalogos/fn_lista_tallas.php",
                "method":"post"
            },
            "order": [],
            "language": {

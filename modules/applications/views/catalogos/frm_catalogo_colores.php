...
<div class="box box-primary">
    <div class="box-header">
        <i class="fa fa-list"></i>Tabla de Colores<br>
        <button class="btn btn-xs btn-primary" onclick="menu_catalogos(5,5)"><i class="fa fa-refresh"></i> Actualizar</button>
        <button class="btn btn-xs btn-default" onclick="nuevo_color(1,0)"><i class="fa fa-file"></i> Nuevo</button>
    ...
    <div id="DataList" class="box-body no-padding">
        <table id="example" class="table table-condensed table-bordered table-striped table-hover">
            ...
            <tr>
                ...
                <th class="bg-bareylev" width="130">Color</th>
                <th class="bg-bareylev">Nombre Color</th>
...
<script>
    ...
    var listar = function(){
        var table = $('#example').DataTable( {
            "ajax":{
                "url":"modules/applications/src/catalogos/fn_lista_colores.php",
                "method":"post"
            },
            "order": [],
            "language": {

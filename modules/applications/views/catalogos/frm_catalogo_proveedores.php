...
<div class="box box-primary">
    <div class="box-header">
        <i class="fa fa-list"></i>Catalogo de Proveedores<br>
        <button class="btn btn-xs btn-primary" onclick="menu_catalogos(7,7)"><i class="fa fa-list"></i> Listado de proveedores</button>
        <button class="btn btn-xs btn-default" onclick="nuevo_proveedor(1,0)"><i class="fa fa-file"></i> Nuevo</button>
    ...
    <div id="DataList" class="box-body table-responsive no-padding" >
        ...
        <table id="example" class="table table-condensed table-bordered table-striped table-hover">
            ...
            <tr>
                ...
                <th class="bg-bareylev">Teléfono 2</th>
...
<script>
    ...
    var listar = function(){
        var table = $('#example').DataTable( {
            "ajax":{
                "url":"modules/applications/src/catalogos/fn_lista_proveedores.php",
                "method":"post"
            },
            "order": [],
            "language": {

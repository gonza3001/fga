...
<div class="box box-primary">
    <div class="box-header">
        <i class="fa fa-list"></i>Catalogo de Sub Categorías<br>
        <button class="btn btn-xs btn-primary" onclick="menu_catalogos(3,3)"><i class="fa fa-list"></i> Lista de sub categorías</button>
        <button class="btn btn-xs btn-default" onclick="nueva_subcategoria(1,0)"><i class="fa fa-file"></i> Nuevo</button>
...
<script>
    ...
    var listar = function(){
        var table = $('#example').DataTable( {
            "ajax":{
                "url":"modules/applications/src/catalogos/fn_lista_subcategorias.php",
                "method":"post"
            },
            "order": [],
            "language": {

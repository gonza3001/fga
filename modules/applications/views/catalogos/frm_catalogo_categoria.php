...
<div class="box box-primary">
    <div class="box-header">
        <i class="fa fa-list"></i>Catalogo Categorías<br>
        <button class="btn btn-xs btn-primary" onclick="menu_catalogos(2,2)"><i class="fa fa-list"></i> Lista de categorías</button>
        <button class="btn btn-xs btn-default" onclick="nueva_categoria(1,0)"><i class="fa fa-file"></i> Nuevo</button>
...
<script>
    ...
    var listar = function(){
        var table = $('#example').DataTable( {
            "ajax":{
                "url":"modules/applications/src/catalogos/fn_lista_categorias.php",
                "method":"post"
            },
            "order": [],
            "language": {

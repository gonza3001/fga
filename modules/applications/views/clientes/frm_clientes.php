...
<div class="box box-primary">
    <div class="box-header">
        <i class="fa fa-list"></i>Catalogo de Clientes<br>
        <button class="btn btn-xs btn-primary" onclick="menu_catalogos(9,9)"><i class="fa fa-list"></i> Listado de clientes</button>
        <button class="btn btn-xs btn-default" onclick="nuevo_cliente(1,0)"><i class="fa fa-file"></i> Nuevo</button>
...
<script>
    ...
    var listar = function(){
        var table = $('#example').DataTable( {
            "ajax":{
                "url":"modules/applications/src/clientes/fn_lista_clientes.php",
                "method":"post"
            },
            "order": [],
            "language": {

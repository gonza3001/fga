    ...
    <div class="modal-dialog">
        <div class="modal-content ">
            <div class="modal-header">
                ...
                <h4 class="modal-title" style="font-size: 14px"> Alta de cliente</h4>
            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        Nombre completo:
                                        <input type="text" id="nombre_cliente" class="form-control" placeholder="Nombre completo del cliente" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        Correo:
                                        <input type="email" id="correo_cliente" class="form-control" placeholder="Correo" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        Teléfono:
                                        <input type="tel" id="telefono_cliente" class="form-control" placeholder="Teléfono" />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        Celular:
                                        <input type="tel" id="celular_cliente" class="form-control" placeholder="Celular" />
                                    </div>
                                </div>
                            </div>
            ...
            <div class="modal-footer">
                <button class="btn btn-success btn-sm" id="btnSave" onclick="nuevo_cliente(2,2)" ><i id="spinner" class="fa fa-save"></i> Guardar</button>

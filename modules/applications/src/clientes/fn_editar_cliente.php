...
if(array_key_exists('nombre_cliente',$_POST) && array_key_exists('idcliente',$_POST) ){
    ...
    if($connect->_confirm){
        ...
        echo '<script>getMessage("Cliente editado correctamente");menu_catalogos(9,9);$("#modalbtnclose").click()</script>';
    ...
    \core\core::MyAlert("No se encontraron los datos para editar el cliente","alert");
}
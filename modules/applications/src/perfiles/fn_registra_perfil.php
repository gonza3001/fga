...
if(array_key_exists('nombre_perfil',$_POST)){
    ...
    if($connect->_confirm){
        ...
        echo "<script>getMessage('Se registro el perfil correctamente');menu_catalogos(12,12);$('#modalbtnclose').click();</script>";

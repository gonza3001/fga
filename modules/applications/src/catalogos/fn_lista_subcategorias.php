...
$lista_categorias = $categorias->get_lista_subcategorias(1,$_SESSION['data_home']['idempresa']);

for($i=0; $i < count($lista_categorias); $i++){

    $arreglo['data'][] = array(
        "funciones"=>'<span class="btn btn-xs btn-info" onclick="editar_subcategoria(1,'.$lista_categorias[$i][0].')" ><i class="fa fa-edit"></i></span> <span class="btn btn-xs btn-warning"><i class="fa fa-trash"></i></span>',

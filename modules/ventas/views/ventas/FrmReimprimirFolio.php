...
<script>
    ...
    $("#folio_venta").on('keyup', function (e) {
        if (e.keyCode == 13) {
            // Do something
            setVentaPagos({'opc':4,'folio':this.value});
        }
    })
</script>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div id="form_pagos" class="modal-body">
                ...
                <div id="detalle_pago" class="row hidden">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label>Importe Total</label>
                            <input id="txtimporte" class="form-control text-center text-bold input-lg currency" readonly>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
                            <label>Importe Pendiente</label>
                            <input id="txtSaldo" class="form-control input-lg text-bold text-center currency" readonly>
                        </div>
                    </div>
                </div>

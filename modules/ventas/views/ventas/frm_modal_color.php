...
$connect->_query = "
SELECT a.idarticulo,idalmacen,b.nombre_articulo,a.existencias,b.idcolor,e.nombre_catalogo,e.descripcion_catalogo
...
WHERE a.existencias > 0 AND a.idalmacen = $idAlmacen AND b.idcategoria = $idCategoria AND b.idsubcategoria = $idSubCategoria AND b.idTalla = $idTalla AND b.idempresa = $idEmpresa GROUP BY b.idcolor
";
                ...
                <div class="row">
                    <div class="col-md-12" style="max-height: 500px;overflow-y: scroll;" >
                        ...
                        for($i=0; $i < count($lista); $i++){
                            ...
                            $valor = $lista[$i][4]."-".$lista[$i][6];

                            echo "<button class='btn btn-app text-bold' style='background: ".$lista[$i][5]."' onclick='$(\"#color\").val(\"".$valor."\");$(\"#mdl_categorias\").modal(\"toggle\")' >".$lista[$i][6]."</button>";
